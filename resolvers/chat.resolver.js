...
let ChatResolver = class ChatResolver {
    ...
    async sendMessage(pubSub, message, conversation, from, to, usuario, isFile, isSys, sysTo) {
        ...
        //console.log(payload);
        await connection.query('INSERT INTO chats VALUES("", "' + payload._id + '", "' + payload.conversation + '", "' + payload.message + '", ' + payload.date + ', "' + payload.from + '","' + payload.to + '", "' + payload.usuario + '", "' + payload.isFile + '", "' + payload.isSys + '" , "' + payload.sysTo + '", "' + payload.leido + '", 1)');
